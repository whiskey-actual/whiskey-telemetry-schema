CREATE TABLE [dbo].[DeviceAzureManaged] (
    ...
    [AzureManagedTotalStorageSpaceInBytes]                  VARCHAR(255)        NULL,
    [AzureManagedFreeStorageSpaceInBytes]                   VARCHAR(255)        NULL,
    ...
    [AzureManagedPhysicalMemoryInBytes]                     VARCHAR(255)        NULL,
    -- dates
