...
CREATE TABLE [dbo].[DeviceActiveDirectory] (
    ...
    [ActiveDirectoryOperatingSystemXRefID]   INT                 NOT NULL    DEFAULT((0)),
    -- dates
...
INSERT INTO DeviceActiveDirectory(DeviceActiveDirectoryID, ActiveDirectoryDN, ActiveDirectoryOperatingSystemXRefID) VALUES (0, 'UNKNOWN', 0)
